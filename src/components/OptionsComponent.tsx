...
function OptionsComponent({name, iterables, setShowComponent}: OptionsProps) {
    ...
    return (
        <div className='mt-5 flex flex-col mx-6 gap-2'>
            ...
            {iterables.map ((item: any) => (
                <div className='rounded-md flex gap-2 cursor-pointer px-2 py-3 hover:bg-gray-200 duration-75' onClick={() => setShowComponent(item.show)}>
